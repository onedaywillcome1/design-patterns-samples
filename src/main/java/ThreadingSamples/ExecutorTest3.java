...
public class ExecutorTest3 {
    ...
    public static int amountOfDivisibleByFuture(final int first, final int last, final int divisor)
        ...
        FutureTask<Integer> futureTask_1 = new FutureTask<Integer>(new Callable<Integer>() {
            @Override
            public Integer call() {
                return ExecutorTest3.amountOfDivisibleBy(first, last / 2, divisor);
            }
        });
        ...
        FutureTask<Integer> futureTask_2 = new FutureTask<Integer>(new Callable<Integer>() {
            @Override
            public Integer call() {
                return ExecutorTest3.amountOfDivisibleBy(last / 2 + 1, last, divisor);
            }
        });
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        int result = ExecutorTest3.amountOfDivisibleBy(0, MAX_NUMBER, 3);
        ...
        int resultFuture = ExecutorTest3.amountOfDivisibleByFuture(0, MAX_NUMBER, 3);
